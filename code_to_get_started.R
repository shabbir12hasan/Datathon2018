...
#------------------------------------
#read folder files again // run top script again
...
for (myOn in myFiles){
  ...
  #manual read
  dt <- fread(myOn,sep="|", nrow=10000,select = c(3,4,9))
...
#write the file
fwrite(allON,'D:/StudyMaterial/DatathonMelb_2018/allon.txt')
...
sl <- fread('D:/StudyMaterial/MelbDatathon2018/stop_locations.txt')
